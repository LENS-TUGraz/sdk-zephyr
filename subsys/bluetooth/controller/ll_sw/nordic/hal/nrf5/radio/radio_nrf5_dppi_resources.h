...
#if defined(CONFIG_SOC_COMPATIBLE_NRF54LX)
#define HAL_PPIB_SEND_ENABLE_PALNA_PPI    _CONCAT(NRF_PPIB_TASK_SEND_, HAL_ENABLE_PALNA_PPI)
#define HAL_PPIB_RECEIVE_ENABLE_PALNA_PPI _CONCAT(NRF_PPIB_EVENT_RECEIVE_, HAL_ENABLE_PALNA_PPI)

#define HAL_PPIB_SEND_DISABLE_PALNA_PPI    _CONCAT(NRF_PPIB_TASK_SEND_, HAL_DISABLE_PALNA_PPI)
#define HAL_PPIB_RECEIVE_DISABLE_PALNA_PPI _CONCAT(NRF_PPIB_EVENT_RECEIVE_, HAL_DISABLE_PALNA_PPI)

#define HAL_PPIB_SEND_ENABLE_FEM_PPI    _CONCAT(NRF_PPIB_TASK_SEND_, HAL_ENABLE_FEM_PPI)
#define HAL_PPIB_RECEIVE_ENABLE_FEM_PPI _CONCAT(NRF_PPIB_EVENT_RECEIVE_, HAL_ENABLE_FEM_PPI)
#endif /* CONFIG_SOC_COMPATIBLE_NRF54LX */
